# Plan de Contenido de 7 Horas: Ácido Fólico (Q129)

## 🧬 Perfil Científico (Basado en Evidencia)
Vitamina B9 esencial para la síntesis de ADN y división celular.

### Beneficios Clave:
- Vital para el desarrollo fetal (embarazo).
- Salud del corazón y glóbulos rojos.
...
- **Concepto**: Explicar por qué el cuerpo necesita Ácido Fólico.
- **Temas**: Mecanismo de acción, señales de deficiencia y absorción.

### Hora 2: Contexto Local y Estilo de Vida en Guatemala
- **Concepto**: Cómo Ácido Fólico soluciona problemas específicos de la audiencia local.
...
- **Temas**: Ácido Fólico + Magnesio, Ácido Fólico + Omega 3, etc.
...
1. "Nutrición esencial para el inicio de la vida y tu salud diaria. Q129."
2. "El apoyo fundamental para tu corazón y energía."
