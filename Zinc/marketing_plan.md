# Plan de Contenido de 7 Horas: Zinc (Q139)

## 🧬 Perfil Científico (Basado en Evidencia)
Mineral traza esencial para la división celular y la función inmunitaria.

### Beneficios Clave:
- Acorta la duración de resfriados.
- Salud de la próstata y niveles de testosterona.
...
- **Concepto**: Explicar por qué el cuerpo necesita Zinc.
- **Temas**: Mecanismo de acción, señales de deficiencia y absorción.

### Hora 2: Contexto Local y Estilo de Vida en Guatemala
- **Concepto**: Cómo Zinc soluciona problemas específicos de la audiencia local.
...
- **Temas**: Zinc + Magnesio, Zinc + Omega 3, etc.
...
1. "El guardián de tus defensas y tu salud hormonal. Q139."
2. "Inmunidad básica y potente para el día a día."
