# Plan de Contenido de 7 Horas: Selenio (Q179)

## 🧬 Perfil Científico (Basado en Evidencia)
Mineral esencial y antioxidante que protege las células del daño por radicales libres.

### Beneficios Clave:
- Salud de la tiroides y metabolismo.
...
- **Concepto**: Explicar por qué el cuerpo necesita Selenio.
- **Temas**: Mecanismo de acción, señales de deficiencia y absorción.

### Hora 2: Contexto Local y Estilo de Vida en Guatemala
- **Concepto**: Cómo Selenio soluciona problemas específicos de la audiencia local.
...
- **Temas**: Selenio + Magnesio, Selenio + Omega 3, etc.
...
1. "El protector invisible de tu tiroides y células. Q179."
2. "Defensa antioxidante de precisión."
